/******************************************************************************
 * @file     vio_STM32F769I-EVAL.c
 * @brief    Virtual I/O implementation for board STM32F769I-EVAL
 * @version  V1.0.0
...
/*! \page vio_STM32F769I-EVAL Physical I/O Mapping
...
| vioLED0       | vioSignalOut.0 | LED red       (LD3)  | PJ1
| vioLED1       | vioSignalOut.1 | LED green     (LD1)  | PI15
| vioLED2       | vioSignalOut.2 | LED blue      (LD4)  | PJ3
| vioLED3       | vioSignalOut.3 | LED orange    (LD2)  | PJ0
*/
...
//  signal,     pin,                   pull resistor,      active state
  { vioLED0,    GPIO_PIN_ID_PORTJ(1),  ARM_GPIO_PULL_NONE, VIO_ACTIVE_LOW },
  { vioLED1,    GPIO_PIN_ID_PORTI(15), ARM_GPIO_PULL_NONE, VIO_ACTIVE_LOW },
  { vioLED2,    GPIO_PIN_ID_PORTJ(3),  ARM_GPIO_PULL_NONE, VIO_ACTIVE_LOW },
  { vioLED3,    GPIO_PIN_ID_PORTJ(0),  ARM_GPIO_PULL_NONE, VIO_ACTIVE_LOW }
};
#endif
